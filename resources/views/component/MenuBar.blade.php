                    ...
                    <div class="text-center text-md-end">
                        <ul class="header_list">
                            ...
                            @if(Cookie::get('token') !== null)
                                ...
                                <li><a class="btn btn-danger btn-sm" href="{{url("/_api/logout")}}"> Logout</a></li>
                            @else
...
<script>
    async function Category(){
        ...
        res.data['data'].forEach((item,i)=>{
            let EachItem= ` <li><a class="dropdown-item nav-link nav_item" href="/category?id=${item['id']}">${item['name']}</a></li>`
