<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-md-3 p-2">
            ...
            <input type="text" id="cus_address" class="form-control form-control-sm"/>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-md-3 p-2">
            ...
            <input type="text" id="ship_address" class="form-control form-control-sm"/>
        </div>
...
<script>
    ...
    async  function ProfileCreate(){
       ...
       let postBody={
        ...
        let res = await axios.post("{{ route('profile.save') }}",postBody);
      ...
      async function ProfileDetails() {
          ...
          let res = await axios.get("{{ route('profile.get') }}");
          if (res.data['data'] !== null) {

              document.getElementById('cus_name').value = res.data['data']['cus_name']
              document.getElementById('cus_address').value = res.data['data']['cus_address']
              ...
              document.getElementById('ship_address').value = res.data['data']['ship_address']
